...
def banner():
	...
	sol().print(wel2)
	au='AUTHOR    :  JIHADAIZDEN & BR3K     :  https://www.facebook.com/Zeyad.Red.X  https://www.facebook.com/alarareyes :  '
	pengembang1=nel(au,style="Purple")
	cetak(nel(pengembang1, title='By Zeyad Alabany'))
...
def login_lagi():
	banner()
	sky = '# TOKEN GET FROM ZEYAD OR JIHAD'
	sky2 = mark(sky, style='Blue')
	sol().print(sky2, style='Blue')
